...
static int i2s_init_default(void)
{
   ...
   * First bit of channel 1 is received on the 1st clock cycle
   * First bit of channel 2 is received on the 33rd clock cycle 
   * Disabled channel 2 to get mono transmission only*/
  printk(KERN_INFO "Setting channel width...");
  i2s->RXC_A = I2S_RXC_A_CH1EN | I2S_RXC_A_CH1POS(0) | I2S_RXC_A_CH1WEX | I2S_RXC_A_CH1WID(0) ;
  i2s->TXC_A = I2S_TXC_A_CH1EN | I2S_TXC_A_CH1POS(0) | I2S_TXC_A_CH1WEX | I2S_TXC_A_CH1WID(0) ;
