...
# getBuffer()
#
# description: This function takes the string array from the deepspeech voice recognition 
#              software. Buffer indexing will be handled in external code. If no more
#              buffers left in array, indicate with a null terminator. 
#
